label train:
    ...
    Y "Y-yeah."
    show shrek_cosplay_discomfort as shrek_cosplay
    ...
    menu:
        "Break the awkward silence":
            ...
            show shrek_cosplay_blush as shrek_cosplay at exp
            "He lights up."
        ...
        "Stare at him lovingly":
            ...
            S "Uhhh...do you want a picture...or...?"
    ...
    show shrek_cosplay_shy as shrek_cosplay at train_halt with vpunch
    ...
    show shrek_cosplay_shy as shrek_cosplay at train_halt2
...
label convention:
    ...
    "Mean Stranger" "No. You look stupid. Your face and forehead are two completely different colors."
    "Mean Stranger" "It looks weird."
    Y "O-oh..."
    "..."
    ...
    if face_paint:
        ...
        show shrek_cosplay_shy as shrek_cosplay at exp
    ...
    show shrek_cosplay as shrek_cosplay
    ...
    scene blackscreen with Dissolve(2)
    pause(1)
    "BAD END: Waste of Space"
    #(prlly rename that one)
    return
